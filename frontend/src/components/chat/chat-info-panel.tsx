...
export function ChatInfoPanel() {
  ...
  return (
    <div className="fixed inset-0 w-full h-full z-50 md:relative md:inset-auto md:w-[340px] md:h-auto shrink-0 md:border-l flex flex-col bg-background md:bg-sidebar/50">
